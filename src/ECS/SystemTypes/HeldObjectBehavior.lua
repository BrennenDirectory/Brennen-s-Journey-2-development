...
function HeldObjectBehavior:throw(otherEntity)
    ...
    self.hitbox:applyLinearImpulse(liftableComponent.throwForce * liftableComponent.throwForceMultiplierX, liftableComponent.throwForce * liftableComponent.throwForceMultiplierY)
end